...
<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
    <script>
        ...
        // Fungsi untuk menampilkan alert dan memainkan suara jika nilai OLWB melebihi 14
        ...
        function checkOLWBValue() {
            ...
            // Memeriksa apakah nilai OLWB melebihi 14 dan berbeda dari nilai terakhir
            if (!isNaN(olwbValue) && olwbValue > 14 && olwbValue !== lastOLWBValue) {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    include 'koneksi.php';
                    $data = mysqli_query($koneksi,"SELECT * FROM ajp_pkefpb");
                    ...
                    <a href="export_excel_pkefpb.php" class="btn btn btn-icon-split btn-sm" style="background-color: #304D30; color: #fff">
                        <span class="icon text-white-50">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header border-left-primary py-3" style="background-color: #16213E;">
                            <h6 class="m-0 font-weight-bold" style="color: #fff">Data PKE FP-B<a href="process3.php"><i class="fas fa-sync fa-spin" style="float:right; color: #fff;"></i></a></h6>
            ...
            $data = mysqli_query($koneksi,"select * from ajp_pkefpb order by idpkefpb DESC");
            //nomor
            $no = 1;
            //mengambil data
            ...
            ?>
                                        ...
                                        <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['created_atpkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['analysis_timepkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['product_namepkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['product_codepkefpb']; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $d['sample_typepkefpb']; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $d['sample_numberpkefpb']; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $d['sample_commentpkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['instrument_namepkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['instrument_serial_numberpkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;" class="<?php echo ($d['olwbpkefpb'] > 14 && $d['olwbpkefpb'] < 16) ? 'table-yellow-bg' : ($d['olwbpkefpb'] > 16 ? 'table-red-bg' : ''); ?>">
                                            <?php echo $d['olwbpkefpb']; ?></td>
                                            <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['vmpkefpb']; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $d['oldbpkefpb']; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $d['nospkefpb']; ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
