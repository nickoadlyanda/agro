...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Palm Kernel KCP</li>
                      </ol>
                    </nav>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header border-left-primary py-3" style="background-color: #16213E;">
                            <h6 class="m-0 font-weight-bold" style="color: #fff">Data Palm Kernel KCP<a href="process.php"><i class="fas fa-sync fa-spin" style="float:right; color: #fff;"></i></a></h6>
            ...
            $data = mysqli_query($koneksi,"select * from palmkernelkcp order by id DESC");
            //nomor
            $no = 1;
            //mengambil data
            ...
            ?>
                                        ...
                                        <td style="vertical-align: middle; text-transform: uppercase;"><?php echo $d['created_at']; ?></td>
                                            ...
                                            <td style="vertical-align: middle; text-transform: uppercase;" class="<?php echo ($d['olwb'] > 0 && $d['olwb'] < 50) ? 'table-red-bg' : ($d['olwb'] > 50 ? 'table-green-bg' : ''); ?>">
    <?php echo $d['olwb']; ?>
</td>
                                            ...
                                            <td style="vertical-align: middle;"><?php echo $d['ffa']; ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
